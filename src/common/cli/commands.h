...
#define CLI_COMMAND_STREAM_ENCODERS      12  // stream regulat encoder samples to host
#define CLI_COMMAND_STREAM_ENCODERS_STOP 13   // reset the encoder recording of ticks 
